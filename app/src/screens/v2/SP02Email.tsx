...
const dict: Record<Lang, {
  ...
  ru: {
    ...
    body: 'Вы оставили заявку на открытие расчётного счёта в Сбербанк Индия. Для продолжения онбординга подтвердите ваш адрес электронной почты, нажав кнопку ниже.',
  ...
  en: {
    ...
    greeting: 'Hello!',
    body: 'You applied to open a current account with Sberbank India. To continue your onboarding, please confirm your email address by clicking the button below.',
