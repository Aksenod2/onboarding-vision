...
const dict: Record<Lang, {
  ...
  ru: {
    ...
    to: 'Кому:',
    subject: 'Тема:',
    subjectValue: 'Подтвердите email',
    greeting: 'Здравствуйте!',
    body: 'Вы оставили заявку на сотрудничество с Банком. Для продолжения онбординга подтвердите ваш адрес электронной почты, нажав кнопку ниже.',
  ...
  en: {
    ...
    to: 'To:',
    subject: 'Subject:',
    subjectValue: 'Confirm your email',
    greeting: 'Hello!',
    body: 'You applied to start a banking relationship with the Bank. To continue your onboarding, please confirm your email address by clicking the button below.',
