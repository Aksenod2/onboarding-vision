...
const MANAGER: Node[] = [
  ...
  // Объединённое окно «отдел работы с клиентами» (CRM+DVU, RBAC, spike). Один вход —
  // shell с role-switcher, реестром и процессным окном. Ссылка-строка — без импорта из crm/ (изоляция).
  { l: 'Отдел работы с клиентами', p: '/rm/crm' },
];
